...
default['kibana']['home']                       = node['hopslog']['dir'] + "/opensearch-dashboards-#{node['kibana']['version']}"
...
default['filebeat']['version']                  = "7.17.2"
default['filebeat']['url']                      = "#{node['download_url']}/opensearch/filebeat-#{node['filebeat']['version']}-linux-x86_64.tar.gz"
